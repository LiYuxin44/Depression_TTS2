...
OUTPUT_FOLDER_BASE = "/data/depression_tts/synthese_data/v9_only_film_099_mask_test"
...
SENTIMENT_POOL_HEALTHY_FILE = os.path.join(SENTIMENT_POOL_DIR, "healthy_text_pool_strict_positive.json")
...
def main():
    ...
    # 仅使用 Healthy_Text_Pool（正向文本）；Depressed_Text_Pool 不再用于生成
