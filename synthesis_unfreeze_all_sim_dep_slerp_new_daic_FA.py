...
OUTPUT_FOLDER_BASE = "/data/depression_tts/synthese_data/v9_only_film_099_FA"
...
def main():
    ...
    # 仅使用 Depressed_Text_Pool（负向文本）；Healthy_Text_Pool 不再用于生成
    ...
    for subject_idx, item in enumerate(generation_plan):
        ...
        # 只生成负向文本：全部来自 Depressed_Text_Pool，不从 Healthy_Text_Pool 取样
