...
#MATCHA_CKPT = "/data/depression_tts/logs/train_daic_utter_no_film_adapter/decouple_unfreeze_all/runs/2025-11-24_00-24-08/checkpoints/checkpoint_epoch=199.ckpt"
...
OUTPUT_FOLDER_BASE = "/data/depression_tts/synthese_data/v9_film_only_099_mask_FA_half"
...
def main():
    ...
    for subject_idx, item in enumerate(generation_plan):
        ...
        if target_sentences < 1:
            ...
            target_sentences = 1
        # 如果总数是奇数，积极文本多一个
        num_healthy = (target_sentences + 1) // 2
